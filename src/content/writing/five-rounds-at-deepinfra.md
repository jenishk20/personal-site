---
title: Five rounds at DeepInfra, and a reason
description: A full SWE loop at a Series B inference startup. Two problem-solving rounds, a fit round, and a cofounder round I did not solve. Rejected, told why, and still in touch with the team.
date: 2026-09-23
tag: interviews
draft: false
---
...
<table class="facts">
    <tbody>
        <tr><th scope="row">Company</th><td>DeepInfra (Series B, AI inference)</td></tr>
        <tr><th scope="row">Team</th><td>Software Engineering, Inference</td></tr>
        <tr><th scope="row">Role</th><td>SWE, experienced</td></tr>
        <tr><th scope="row">Location</th><td>Rounds 1 to 3 remote, 4 and 5 onsite in Palo Alto, CA</td></tr>
        <tr><th scope="row">Date</th><td>April 2026</td></tr>
        <tr><th scope="row">How it started</th><td>Cold application</td></tr>
        <tr><th scope="row">Rounds</th><td>5</td></tr>
        <tr><th scope="row">Outcome</th><td>Rejected, with feedback</td></tr>
    </tbody>
</table>

The other side of the <a href="/four-rounds-at-amazon-seattle-hq/">Amazon loop</a>. Same result, completely different experience of it.

## The loop

The first three rounds were remote. The last two were onsite in Palo Alto.
...
I was told why. That sounds like a low bar and it is, but it is one that a great many companies do not clear. Four rounds of real technical conversation ended with a specific reason instead of silence, and the reason was actionable.
